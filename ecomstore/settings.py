...
SECRET_KEY = 'django-insecure-=ejc^$_j^y8z^$v5lx$h=-c6@u*$6o#hf+=v#(y3o$u45ly7u#'
...
DATABASE_ROUTERS = [
    ...
    'database_multi_config.database_routers.MongoDB',# Đường dẫn thực tế đến BookRouter
]
